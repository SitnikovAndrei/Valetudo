...
import {Capability, ValetudoRestrictedZoneType, type Point} from "../api/types";
import {RawMapEntityType, type RawMapEntity} from "../api/RawMapData";
import {fetchCombinedVirtualRestrictionsProperties, sendCombinedVirtualRestrictionsUpdate} from "../api/client";
...
<template>
    <div class="page">
        <PageHeader :title="$t('Virtual restrictions')" />
        <section class="panel">
