...
import {fetchDuststreamingProperties, fetchHighResolutionManualControlState, fetchManualControlProperties, fetchManualControlState, sendHighResolutionManualControlInteraction, sendManualControlInteraction} from "../api/client";
...
const cameraConfiguration = useQuery({...duststreamConfigurationQuery, enabled: cameraSupported});
...
<template>
    <div class="page max-w-2xl">
        <PageHeader :title="$t('Manual control')" />
        <section class="panel">
