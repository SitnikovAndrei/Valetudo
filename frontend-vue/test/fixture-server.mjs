...
const responses = new Map([
    ["/api/v2/robot/capabilities", ["BasicControlCapability", "TotalStatisticsCapability", "MapSegmentationCapability", "ZoneCleaningCapability", "GoToLocationCapability", ...(embedded ? ["WifiConfigurationCapability", "WifiScanCapability"] : []), ...(rich ? ["CarpetSensorModeControlCapability", "CleanRouteControlCapability", "AutoEmptyDockAutoEmptyIntervalControlCapability", "AutoEmptyDockAutoEmptyDurationControlCapability", "MopDockMopWashTemperatureControlCapability", "MopDockMopDryingTimeControlCapability", "CombinedVirtualRestrictionsCapability", "MapAnnotationsCapability", "MapSegmentEditCapability", "MapSegmentRenameCapability", "MapSegmentMaterialControlCapability"] : [])]],
    ...
    ["/api/v2/robot/state/map", fixtureMap],
